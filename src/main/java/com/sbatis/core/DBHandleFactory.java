...
import com.sbatis.core.sql.SqlHandleProvider;
 ...
 * @param <T>
 */
public abstract class DBHandleFactory<T extends CommonEntity> {
	...
	/**
	 * 1、根据传入的 QueryProvider 对象，查询一条 BaseEntity 子类的记录。
	 * 2、如果根据条件有多条数据符合，则抛出异常。
	 * @author HuangLongPu
	 * @param queryProvider
	 * @return
