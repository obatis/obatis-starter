...
public abstract class DBHandleFactory<T extends BaseCommonEntity> {
	...
	public T findById(QueryProvider queryProvider, BigInteger id) {
		queryProvider.addFilterEquals(BaseCommonField.FIELD_ID, id);
	...
	public T findBySql(String sql, List<Object> list) {
		return this.getBaseBeanSessionMapper().getBySql(sql, list);
	}
	...
	public Object findObjectBySql(String sql, List<Object> list) {
		return this.getBaseBeanSessionMapper().getObjectBySql(sql, list);
	}
	...
	public int findTotal(String sql, List<Object> list) {
		return this.getBaseBeanSessionMapper().getTotalByParam(sql, list);
	}
	...
	public <M> M findBySql(String sql, List<Object> list, Class<M> resultCls) {
		return this.getBaseResultSessionMapper(resultCls).getBySqlR(sql, list);
	}
	...
	public Map<String, Object> findMapBySql(String sql, List<Object> list) {
		return this.getBaseBeanSessionMapper().getMapBySql(sql, list);
	}
	...
	public PageResultInfo<T> page(String sql, String totalSql, List<Object> list, int pageNumber, int pageSize) {
		...
		sql = SqlProvider.appendPageSql(sql, pageNumber, pageSize, reset);
	...
	public PageResultInfo<T> page(QueryProvider queryProvider) {
		...
		providerMap.put(SqlConstant.PARAM_OBJ, queryProvider);
		// 拼装SQL语句
		SqlProvider.getQueryPageSql(providerMap, this.getTableName());

		int total = this.getBaseBeanSessionMapper().getTotal((String) providerMap.get(SqlConstant.COUNT_SQL), providerMap);
